...
print('\nExample for loops with the range() function')
...
print('\nExample nested for loops with the range() function')
...
print('\nExample 2 nested for loop with range() functions')
...
print('\nExample while loops with if-else statements')
